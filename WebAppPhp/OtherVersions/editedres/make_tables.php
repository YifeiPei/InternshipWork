...
$query = sqlsrv_query($connect, $tbl_available);
if ($query === TRUE) {
...
$query = sqlsrv_query($connect, $tbl_confirms);
if ($query === TRUE) {
...
$query = sqlsrv_query($connect, $tbl_reserves);
if ($query === TRUE) {
...
$query = sqlsrv_query($connect, $tbl_insert);
if ($query === TRUE) {
